...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/gapiLiveChat.ts");
/******/ })
/************************************************************************/
/******/ ({
...
const AppendLiveChatList = (list) => __awaiter(void 0, void 0, void 0, function* () {
...
(function () {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const query = query_string_1.default.parseUrl(window.location.href).query;
        if (query.v === undefined)
            return;
        const video_id = query.v;
        console.log(video_id);
        const video = yield get_axios_1.getVideoDetails(video_id);
        console.log('video', video);
        if (!video || !((_a = video === null || video === void 0 ? void 0 : video.liveStreamingDetails) === null || _a === void 0 ? void 0 : _a.activeLiveChatId))
            return;
        let nextPageToken = '';
        let pollingInterval = 0;
        const liveChatId = video.liveStreamingDetails.activeLiveChatId;
        const runRequestByPollingInterval = () => __awaiter(this, void 0, void 0, function* () {
            const chat = yield get_axios_1.getLiveMessages(liveChatId, nextPageToken.length > 0 ? nextPageToken : undefined);
            console.log('live chat', chat);
            if (chat === null || chat === void 0 ? void 0 : chat.nextPageToken)
                nextPageToken = chat.nextPageToken;
            if (chat === null || chat === void 0 ? void 0 : chat.pollingIntervalMillis)
