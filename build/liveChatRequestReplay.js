...
chrome.runtime.onMessage.addListener((message, sender) => __awaiter(void 0, void 0, void 0, function* () {
    if (sender.id === chrome.runtime.id && message.url) {
        axios_1.default.get(message.url).then(res => console.log(res.data));
    }
}));
