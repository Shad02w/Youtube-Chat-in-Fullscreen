...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/liveChatRequestReplay.ts");
/******/ })
/************************************************************************/
/******/ ({
...
(function () {
    ...
    chrome.runtime.onMessage.addListener((message) => __awaiter(this, void 0, void 0, function* () {
        console.log(message);
        const res = yield axios_1.default.get(message.url);
        const data = res.data;
        if (data.response.continuationContents.liveChatContinuation.actions &&
            data.response.continuationContents.liveChatContinuation.actions.length === 0)
            return;
