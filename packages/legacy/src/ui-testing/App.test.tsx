            ...
            <div className={containerClasses.container}>
                {data.map((action, i) => {
                    ...
                    if (liveChatPaidMessageRenderer)
                        return <LiveChatPaidMessage key={i} renderer={liveChatPaidMessageRenderer}
classes={classes} />
                    else if (liveChatTextMessageRenderer)
                        return <LiveChatTextMessage key={i} renderer={liveChatTextMessageRenderer}
classes={classes} />
                        ...
                        return <LiveChatPaidStickerRenderer renderer={liveChatPaidStickerRenderer} classes={classes} />
            ...
            <Button startIcon={<Done />} variant="contained"
